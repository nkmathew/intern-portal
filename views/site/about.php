...
<div class="site-about">
    ...
    <p>A system that automates the internship process essentially doing away with the need for a logbook for keeping
    ...
    <ul>
        ...
        <li>Should support login for three types of users:
            <ul>
                <li>Coordinators
                    <ul>
                        <li>The teacher/lecturer in who does supervision of all the interns from a certain class and
                            does an on site assessment of the student interns in their placements
                        </li>
                    </ul>
                </li>
                <li>Supervisors
        ...
        <li>Coordinator:
            <ul>
                ...
                <li>Should be able to see the progress of all the students in the class doing the internship
                </li>
                <li>System has an option for sending mass emails to all the students with links that enable them to
                    signup to the system and changing their loggin details
                </li>
            </ul>
        </li>
        <li>Supervisor
            <ul>
                ...
                <li>Decides the number of weeks the intern is supposed to be on internship. The minimum should be at
                    least 8 weeks required by all institutions
                </li>
                ...
                <li>Should have a form that enables the supervisor to note down the students progress during the
                    internship
                </li>
            </ul>
        </li>
            ...
            <ul>
                ...
                <li>Should show the intern his/her progess including:
                    <ul>
                        ...
                        <li>The number of hours completed in general taking into account the working hours defined by
                            the supervisor
                        </li>
                        <li>The number of days left to complete the 8/12 weeks set</li>
                    </ul>
                </li>
                <li>Signs up in the system only on invite from the email sent by the coordinator to the school email
                    address.
                </li>
